...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.transaction(async (t) => {
      ...
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_subscription_plans_status";', { transaction: t });
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_subscription_plans_billing_period";', { transaction: t });
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.dropTable('subscription_plans', { transaction: t });
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_subscription_plans_status";', { transaction: t });
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_subscription_plans_billing_period";', { transaction: t });
    });
  }
